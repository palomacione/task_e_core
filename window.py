...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_nome.setGeometry(QtCore.QRect(30, 40, 50, 20))
        ...
        self.label_idade.setGeometry(QtCore.QRect(190, 40, 40, 20))
        ...
        self.alphaListbutton.setGeometry(QtCore.QRect(30, 120, 180, 23))
        self.alphaListbutton.setObjectName("alphaListbutton")
        self.ageListButton = QtWidgets.QPushButton(self.centralwidget)
        self.ageListButton.setGeometry(QtCore.QRect(220, 120, 180, 23))
        ...
        self.listclassify.setGeometry(QtCore.QRect(170, 320, 200, 21))
